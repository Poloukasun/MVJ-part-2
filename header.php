    ...
    <div class="header-right">
        <div class="searchBar-container">
            <form class="research-form">
                <input class="input-search" id="search" type="search" placeholder="Rechercher dans mvj..." />
                <button class="search-btn" type="submit" title="Rechercher">
                    <i class="fa-solid fa-magnifying-glass"></i>
                </button>
            </form>
        </div>
        <div>&nbsp;</div>
        <a href="./riends.php"><i class="fa-solid fa-user-group"><i class="label"> amis</i></i></a>
