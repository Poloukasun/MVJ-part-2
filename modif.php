...
if ($_SERVER['REQUEST_METHOD'] === 'GET' || $_SERVER['REQUEST_METHOD'] === 'POST') {
  if(isset($_POST['del-btn'])) {
    ...
    if(UserDao::delete_account($user['idUser'])) {
      delete_session();
...
<body class="friends">
  ...
  <form class="update-form" method="POST">
    ...
    <div class="modification">
      ...
      <div class="delete-acc" style="text-align: center;"><button type="button" class="del-btn-account" id="del-acc">Supprimer compte</button></div>
    </div>
  </form>
  ...
  <div class="confirm-box">
    ...
    <form method="post">
      <button class="yes-btn" name="del-btn">Oui</button>
    </form>
